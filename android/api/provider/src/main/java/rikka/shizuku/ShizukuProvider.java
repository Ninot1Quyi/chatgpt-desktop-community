...
public class ShizukuProvider extends ContentProvider {
    ...
    private static final String EXTRA_BINDER = "com.ninotquyi.codex.mobile.intent.extra.BINDER";

    public static final String PERMISSION = "com.ninotquyi.codex.mobile.permission.API_V23";

    public static final String MANAGER_APPLICATION_ID = "com.ninotquyi.codex.mobile";
