...
public class BinderSender {
    ...
    private static final String PERMISSION_MANAGER = "com.ninotquyi.codex.mobile.permission.MANAGER";
    private static final String PERMISSION = "com.ninotquyi.codex.mobile.permission.API_V23";
