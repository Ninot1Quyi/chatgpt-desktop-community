...
public class ShizukuShellLoader {
    ...
    private static void requestForBinder() throws RemoteException {
        ...
        Intent intent = new Intent("com.ninotquyi.codex.mobile.intent.action.REQUEST_BINDER")
                .setPackage("com.ninotquyi.codex.mobile")
        ...
        try {
            ...
            Intent activityIntent = Intent.createChooser(
                    new Intent("com.ninotquyi.codex.mobile.intent.action.REQUEST_BINDER")
