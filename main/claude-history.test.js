...
async function makeFixture() {
  const root = await fs.promises.mkdtemp(path.join(os.tmpdir(), "noma-claude-history-"));
...
test("lists primary Claude sessions and reads a transcript into Noma turns", async (t) => {
