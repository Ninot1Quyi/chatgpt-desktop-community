...
import { useStore, normalizePermission } from "@app/store.js";
import { cx } from "@app/lib/cx.js";
import { Card, Row, Toggle, Dropdown, Btn, lsGet, lsSet } from "./shared.jsx";
import { IconChevronDown, IconCheck } from "@app/components/icons.jsx";
  ...
  return (
    <>
      ...
      <Card title="Workspace Dependencies">
        <Row title="Community client dependencies" desc="Allow ChatGPT to install and expose bundled Node.js and Python tools" />
        <Row title="Diagnose workspace issues" desc="Checks the current bundle and records diagnostic logs">
