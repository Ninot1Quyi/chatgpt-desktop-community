...
const PETS = [
  ...
  ["clawd", "Clawd", "A compact community pet based on official Claude Code pixel Clawd frames, extracted without stretching."],
  ["codex", "Codex", "The original community companion."],
