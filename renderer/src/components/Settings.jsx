...
import ConfigurationSection from "./settings/ConfigurationSection.jsx";
import PersonalizationSection from "./settings/PersonalizationSection.jsx";
import PetsSection from "./settings/PetsSection.jsx";
import AppshotsSection from "./settings/AppshotsSection.jsx";
import PluginsSection from "./settings/PluginsSection.jsx";
import BrowserSection from "./settings/BrowserSection.jsx";
import ComputerUseSection from "./settings/ComputerUseSection.jsx";
import HooksSection from "./settings/HooksSection.jsx";
import ConnectionsSection from "./settings/ConnectionsSection.jsx";
import GitSection, { GitInstructionsSections } from "./settings/GitSection.jsx";
import EnvironmentsSection from "./settings/EnvironmentsSection.jsx";
import WorktreesSection from "./settings/WorktreesSection.jsx";
